...
st.markdown(
    ...
    <style>
        ...
        div[data-testid="stDataEditor"] [data-testid="stDataFrameResizable"] [role="columnheader"] p {{
...
def render_table_block(block_df: pd.DataFrame, accent: bool = False, block_key: str = "", chart_key: str | None = None):
    st.plotly_chart(
        make_table(
            block_df,
            header_fill=PRIMARY,
